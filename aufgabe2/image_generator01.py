...
model = torch.load("../../../../../../../../../vol/tmp/gruppe_b/64x64/model_best.tar", map_location=torch.device('cpu'))
model = model.cpu()
pca = jl.load("../../../../../../../../../vol/tmp/gruppe_b/64x64/pca256.pkl")
scaler_y = jl.load("../../../../../../../../../vol/tmp/gruppe_b/64x64/scaler_yPCA.joblib")
scaler_x = jl.load("../../../../../../../../../vol/tmp/gruppe_b/64x64/scaler_xPCA.joblib")
...
def score(imgo,print):
    ...
    plt.tight_layout()
    plt.savefig(f"plots/final_cluster_gen.png")
...
study.optimize(optimize, n_trials=100000)
